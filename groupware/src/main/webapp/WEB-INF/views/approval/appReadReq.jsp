						...
						<div class="card-body">
							<div class="col" style="float: right; padding: 0px;">
								<div class="form-group" style="float: right;">
									<button type="submit" class="btn btn-primary btn-sm" style="margin-right: 10px;">승인</button>
									<button type="reset" class="btn btn-secondary btn-sm" style="" onclick="location.href='appMain'">반려</button>
								</div>
							</div>
