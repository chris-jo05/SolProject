					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							<div class="card-title">
								<p class="font-weight-bold" style="font-size: 20px; margin-bottom: 0px">연차신청서</p>
							</div>
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-4">
									<table id="table1" onclick="appchartpop()" class="table table-bordered" style="height: 92.5%; cursor: pointer;">
										<tbody>
											<tr style="height: 0">
