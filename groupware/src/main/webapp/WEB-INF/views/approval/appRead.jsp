					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							<div class="card-title">
								<p class="font-weight-bold" style="font-size: 20px; margin-bottom: 0px">${approvalRead.docClass}</p>
							</div>
								...
								<div class="col-md-8">
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input type="text" class="form-control" id="colFormLabel" value="${approvalRead.docNo}" disabled>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input type="text" class="form-control" id="colFormLabel" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${approvalRead.docDate}" />" disabled>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input name="dno" type="text" class="form-control" id="colFormLabel" value="${approvalRead.dname}" disabled>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input name="eno" type="text" class="form-control" id="colFormLabel" value="${approvalRead.ename}" disabled>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col">
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input name="docTitle" type="text" class="form-control" id="docTitle" value="${approvalRead.docTitle}" disabled>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col">
												<input style="height: 500px" name="docContent" type="text" class="form-control" id="docContent" value="${approvalRead.docContent}" disabled>
											</div>
										</div>
									</div>
